...
export const Avatar = forwardRef<HTMLDivElement, AvatarProps>(
    ({ className, src, alt = 'Avatar', size = 'sm', ring = false, status, ...props }, ref) => {
        const sizes = {
            sm: 'w-10 h-10',
            lg: 'w-20 h-20',
        };
                ...
                <div className={cn('rounded-full', sizes[size], ringStyles)}>
                    ...
                    >
                        {src ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-linear-to-br from-primary to-indigo-800 text-white font-bold text-xl">
