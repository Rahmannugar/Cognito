        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-1 md:gap-4">
              ...
              <Link
                to="/login"
                className="hidden md:block text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-blue-600 transition-colors"
              >
                Sign In
              </Link>
            ...
            >
              <nav className="flex flex-col gap-10">
                ...
                <div className="pt-10 border-t border-slate-200 dark:border-white/10 flex flex-col gap-8">
                  <Link
                    to="/login"
                    className="text-2xl font-black uppercase tracking-widest text-slate-400"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Sign In
                  </Link>
        ...
        <main className="relative z-10">
          <section className="pt-32 pb-20 md:pt-48 md:pb-40 px-6">
            <div className="max-w-7xl mx-auto text-center">
              ...
              >
                Cognito transforms passive content into interactive knowledge.
                Built for students and professionals who value their time.
              </motion.p>
                ...
                <div className="bg-slate-50 dark:bg-[#05070a]/80 backdrop-blur-3xl rounded-[28px] md:rounded-[36px] overflow-hidden border border-slate-200 dark:border-white/5 shadow-2xl flex flex-col min-h-[400px] lg:aspect-16/10">
                  ...
                  <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="flex-1 p-6 md:p-10 flex flex-col gap-8 relative">
                      ...
                      <div className="mt-auto h-12 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/3 flex items-center px-4 gap-3 shadow-sm">
          ...
          <section
            id="features"
            className="py-20 md:py-40 px-6 border-t border-slate-100 dark:border-white/5"
          >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {FEATURES.map((feature, i) => (
                  <motion.div
                    ...
                    className={cn(
                      "group relative p-8 md:p-10 rounded-3xl border border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/1 hover:bg-white dark:hover:bg-white/3 transition-all duration-300",
                      feature.className,
                    )}
                  >
                    <div className="relative z-10">
                      <div
                        className={cn(
                          "w-12 h-12 rounded-xl bg-linear-to-br flex items-center justify-center mb-8 shadow-sm",
                          feature.gradient,
                        )}
                      >
                      ...
                      <p className="text-base text-slate-500 dark:text-slate-400 font-medium leading-relaxed tracking-tight">
                        {feature.description}
                      </p>
                    </div>
                  </motion.div>
          ...
          <section className="py-20 md:py-40 px-6 bg-slate-50/50 dark:bg-white/1 border-y border-slate-100 dark:border-white/5 text-center">
            <div className="max-w-4xl mx-auto px-4">
              <h2 className="text-3xl md:text-5xl font-black mb-10 tracking-tight leading-tight">
                "Cognito helps you build a solid mental model of the world's
                most complex topics through structured dialogue."
              </h2>
